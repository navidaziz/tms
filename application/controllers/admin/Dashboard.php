...
trainings.title as t_title,
trainings.department_id,
count(*) as total_participants,
SUM(
  CASE
    WHEN users.gender = "Male" 
    THEN 1 
    ELSE 0 
  END
) AS "male",
...
SUM(CASE WHEN `training_nominations`.`nomination_type` = "Trainee" THEN 1 ELSE 0 END) AS "Trainee",
SUM(CASE WHEN `training_nominations`.`nomination_type` = "Facilitator" THEN 1 ELSE 0 END) AS "Facilitator"
...
trainings.training_id order by trainings.department_id ASC';
        ...
        $this->data['trainings'] = $department;
      ...
      ////  $data = $this->training_model->get_training_list($where);
        ...
        $this->data["view"] = ADMIN_DIR . "dashboard/dashboard_view";
