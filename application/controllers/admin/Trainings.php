...
class Trainings extends Admin_Controller
{
    ...
    public function add_nomination_form()
    {
        ...
        $this->data['nomination_type'] = $this->input->post('nomination_type');
        $this->data['title'] = 'Add Nomination';
    ...
    public function add_nomination()
    {
        ...
        if ($this->input->post('user_id')) {
            ...
            $this->form_validation->set_rules('cnic', 'CNIC', 'required|exact_length[15]|is_unique[users.cnic]');
        }
