...
<th><?php echo $this->lang->line('address'); ?></th><th><?php echo $this->lang->line('Action'); ?></th>
                        </tr>
						</thead>
						<tbody>
            ...
            <td>
                <?php echo $department->address; ?>
                                ...
                                <a class="llink llink-view" href="<?php echo site_url("departments/view_department/".$department->department_id."/".$this->uri->segment(4)); ?>"> View </a>
                            </td>
                         </tr>
                      <?php endforeach; ?>
						</tbody>
