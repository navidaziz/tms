...
<th><?php echo $this->lang->line('detail'); ?></th><th><?php echo $this->lang->line('Action'); ?></th>
                        </tr>
						</thead>
						<tbody>
            ...
            <td>
                <?php echo $training->detail; ?>
                                ...
                                <a class="llink llink-view" href="<?php echo site_url("trainings/view_training/".$training->training_id."/".$this->uri->segment(4)); ?>"> View </a>
                            </td>
                         </tr>
                      <?php endforeach; ?>
						</tbody>
