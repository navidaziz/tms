<div class="modal-header">
    <h5 style="display: inline;" class="modal-title" id="g_modal_title">Update Profile</h5>
...
<div class="modal-body">
    <form id="profile_update" method="post">
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-8">
                <input type="text" value="<?php echo $user->user_password; ?>" class="form-control" id="user_password" name="user_password" placeholder="Account Password">
            </div>
        </div>
    ...
    <script>
        $('#profile_update').submit(function(e) {
            ...
            $.ajax({
                type: 'POST',
                url: '<?php echo site_url(ADMIN_DIR . "/facilitators/profile_update"); ?>',
                data: formData,
