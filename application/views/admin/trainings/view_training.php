      ...
      <div class="box-body">
        ...
        <div class="tabbable header-tabs">
          <ul class="nav nav-tabs">
            ...
            <li <?php if ($this->input->get('tab') == 'nomination') { ?>class="active" <?php } ?>> <a href="<?php echo site_url(ADMIN_DIR . "trainings/view_training/" . $training->training_id) . "?tab=nomination" ?>"> <i class="fa fa-users"></i> <span class="hidden-inline-mobile">Trainees Nominations</span></a> </li>
            <li <?php if ($this->input->get('tab') == 'training') { ?>class="active" <?php } ?>> <a href="<?php echo site_url(ADMIN_DIR . "trainings/view_training/" . $training->training_id) . "?tab=training" ?>"><i class="fa fa-tasks" aria-hidden="true"></i> <span class="hidden-inline-mobile">Training Batches</span></a> </li>
          </ul>
                ...
                <div class="col-md-12">
                  <div class="table-responsive">
                    <table class="table">
                      ...
                      <tr>
                        <td><a href="<?php echo site_url(ADMIN_DIR . "trainings/remove_traning_mcq/" . $training->training_id . "/" . $s_mcq->training_mcq_id); ?>" onclick="return confirm('Are you sure? you want to remove')"><i class="fa fa-times" aria-hidden="true"></i></a></td>
                        ...
                        <td style="cursor: pointer;"><span onclick="$('#answer_<?php echo $s_mcq->training_mcq_id ?>').show();$('#blank_<?php echo $s_mcq->training_mcq_id ?>').hide();" id="blank_<?php echo $s_mcq->training_mcq_id ?>">****</span> <span onclick="$('#blank_<?php echo $s_mcq->training_mcq_id ?>').show();$('#answer_<?php echo $s_mcq->training_mcq_id ?>').hide();" style="display: none;" id="answer_<?php echo $s_mcq->training_mcq_id ?>"> <?php echo $s_mcq->answer; ?> </span></td>
                      </tr>
                      <?php } ?>
                    </table>
                ...
                <div class="col-md-4">
                  <div class="table-responsive">
                    <table style="font-size:11px; width: 100%; border-collapse: separate; border-spacing: 2px; margin-bottom:10px; border:1px solid lightgray; border-radius:5px;">
                      ...
                      <tbody>
                        <tr>
                          <td style="border-left: 2px solid gray; padding-left:5px; "><?php echo $this->lang->line('level'); ?>
                            </th>
                          <td><?php echo $training->level; ?></td>
                        </tr>
                        <tr>
                          <td style="border-left: 2px solid gray; padding-left:5px; "><?php echo $this->lang->line('category'); ?>
                            </th>
                          <td><?php echo $training->category; ?></td>
                        </tr>
                        <tr>
                          <td style="border-left: 2px solid gray; padding-left:5px; "><?php echo $this->lang->line('sub_category'); ?>
                            </th>
                          <td><?php echo $training->sub_category; ?></td>
                        </tr>
                        <tr>
                          <td style="border-left: 2px solid gray; padding-left:5px; "><?php echo $this->lang->line('type'); ?>
                            </th>
                          <td><?php echo $training->type; ?></td>
                        </tr>
                        <tr>
                          <td style="border-left: 2px solid gray; padding-left:5px; "><?php echo $this->lang->line('training_for'); ?>
                            </th>
                          <td><?php echo $training->training_for; ?></td>
                        </tr>
                        <tr>
                          <td style="border-left: 2px solid gray; padding-left:5px; "><?php echo $this->lang->line('location'); ?>
                            </th>
                          <td><?php echo $training->location; ?></td>
                        </tr>
                        <tr>
                          <td style="border-left: 2px solid gray; padding-left:5px; "><?php echo $this->lang->line('start_date'); ?>
                            </th>
                          <td><strong><?php echo date('l j F Y', strtotime($training->start_date)); ?></strong></td>
                        </tr>
                        <tr>
                          <td style="border-left: 2px solid gray; padding-left:5px; "><?php echo $this->lang->line('end_date'); ?>
                            </th>
                          <td><strong><?php echo date('l j F Y', strtotime($training->end_date)); ?></strong></td>
                        </tr>
                        <tr>
                          <td colspan="2" style="border-left: 2px solid gray; padding-left:5px; "><hr />
                            <strong><?php echo $this->lang->line('detail'); ?></strong><br />
                            <?php echo $training->detail; ?></td>
                        </tr>
                        <tr>
                          <th><?php echo $this->lang->line('Status'); ?></th>
                          <td><?php echo status($training->status); ?></td>
                        </tr>
                        <tr>
                          <td colspan="2" style="text-align: center;"><?php if ($training->training_status == 0 or $training->training_status == 1) { ?>
                          ...
                          <tbody>
                            ...
                            <tr <?php if ($batch->status == 2) { ?> style="text-decoration:line-through" <?php } ?>>
                              ...
                              <td><?php if ($batch->status == 2) { ?>
                                ...
                                <span style="margin: 2px;"></span> <a style="padding: 1px;" href="<?php echo site_url(ADMIN_DIR . "trainings/training_batch/" . $training->training_id . "/" . $batch->batch_id); ?>?tab=session" class="btn btn-link btn-sm">Manage</a>
                                <?php } ?></td>
                            </tr>
                            <?php endforeach; ?>
                          </tbody>
                ...
                <div class="table-responsive" style="overflow-y: auto;">
                  <table class="table" style="font-size: 11px;" id="d_table">
                    ...
                    <tbody>
                      ...
                      <tr>
                        <td><a href="<?php echo site_url(ADMIN_DIR . "trainings/remove_nomination/" . $training->training_id . "/" . $nomination->id); ?>" onclick="return confirm('Are you sure? you want to remove')"> <i class="fa fa-times" aria-hidden="true"></i></a></td>
                        <td><?php echo $count++; ?></td>
