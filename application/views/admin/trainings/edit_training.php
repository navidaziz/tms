            ...
            <div class="form-group">
                ...
                <?php
                    $label = array(
                        ...
                        "style" => "",
                    ); echo form_label($this->lang->line('code'), "code", $label);      ?>
                ...
                <?php
                    ...
                    $text = array(
                        ...
                        "id"            =>  "code",
                        "class"         =>  "form-control",
                        "style"         =>  "","required"	  => "required","title"         =>  $this->lang->line('code'),
                        "value"         =>  set_value("code", $training->code),
                        "placeholder"   =>  $this->lang->line('code')
                    );
            ...
            <div class="form-group">
                ...
                <?php
                    ...
                    $text = array(
                        ...
                        "value"         =>  set_value("level", $training->level),
            ...
            <div class="form-group">
                ...
                <?php
                    ...
                    $text = array(
                        ...
                        "value"         =>  set_value("category", $training->category),
            ...
            <div class="form-group">
                ...
                <?php
                    ...
                    $text = array(
                        ...
                        "value"         =>  set_value("sub_category", $training->sub_category),
            ...
            <div class="form-group">
                ...
                <?php
                    ...
                    $text = array(
                        ...
                        "value"         =>  set_value("type", $training->type),
            ...
            <div class="form-group">
                ...
                <?php
                    ...
                    $text = array(
                        ...
                        "value"         =>  set_value("training_for", $training->training_for),
            ...
            <div class="form-group">
                ...
                <?php
                    ...
                    $text = array(
                        ...
                        "value"         =>  set_value("location", $training->location),
            ...
            <div class="form-group">
                ...
                <?php
                    ...
                    $date = array(
                        ...
                        "value"         =>  set_value("start_date", $training->start_date),
            ...
            <div class="form-group">
                ...
                <?php
                    ...
                    $date = array(
                        ...
                        "value"         =>  set_value("end_date", $training->end_date),
            ...
            <div class="form-group">
                ...
                <?php
                    ...
                    $textarea = array(
                        ...
                        "rows"          =>  "",
                        "cols"          =>  "",
                        "value"         => set_value("detail", $training->detail),
