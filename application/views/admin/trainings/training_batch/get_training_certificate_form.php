...
<form id="training_certificates" class="form-horizontal" enctype="multipart/form-data" method="post">
    <input type="text" name="certificate_id" value="<?php echo $input->certificate_id; ?>" />

    <div class="form-group row">
        <label for="certificate_title" class="col-sm-4 col-form-label">Certificate Title</label>
        <div class="col-sm-8">
            <textarea required id="certificate_title" name="certificate_title" class="form-control"><?php echo $input->certificate_title; ?></textarea>
        </div>
    </div>
    ...
    <div class="form-group row">
        ...
        <div class="col-sm-8">
            <textarea required id="certficate_sub_title" name="certficate_sub_title" class="form-control"><?php echo $input->certficate_sub_title; ?></textarea>
        </div>
    </div>
    ...
    <div class="form-group row">
        ...
        <div class="col-sm-8">
            <textarea required id="certificate_for" name="certificate_for" class="form-control"><?php echo $input->certificate_for; ?></textarea>
        </div>
    </div>
    ...
    <div class="form-group row">
        ...
        <div class="col-sm-8">
            <textarea required id="awarded_to" name="awarded_to" class="form-control"><?php echo $input->awarded_to; ?></textarea>
        </div>
    </div>
    ...
    <div class="form-group row">
        ...
        <div class="col-sm-8">
            <textarea required id="training_title" name="training_title" class="form-control"><?php echo $input->training_title; ?></textarea>
        </div>
    </div>
    ...
    <div class="form-group row">
        ...
        <div class="col-sm-8">
            <textarea required id="certificate_footer" name="certificate_footer" class="form-control"><?php echo $input->certificate_footer; ?></textarea>
        </div>
    </div>
    ...
    <div class="form-group row">
        ...
        <div class="col-sm-8">
            <textarea required id="left_signatory" name="left_signatory" class="form-control"><?php echo $input->left_signatory; ?></textarea>
        </div>
    </div>
    ...
    <div class="form-group row">
        ...
        <div class="col-sm-8">
            <textarea required id="right_signatory" name="right_signatory" class="form-control"><?php echo $input->right_signatory; ?></textarea>
        </div>
    </div>
