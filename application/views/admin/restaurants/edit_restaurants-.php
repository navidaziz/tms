...
<div class="row">
    ...
    <td><input required="required" type="text" class="form-control" id="restaurant_latitude" name="restaurant_latitude" value="<?php echo  $restaurants->restaurant_latitude; ?>"  /></td>
    <td><input  required="required" type="text" name="restaurant_longitude" id="restaurant_longitude" class="form-control" value="<?php echo  $restaurants->restaurant_longitude; ?>" /></td>
    </tr></table>
    <script>
      ...
      function initAutocomplete() {
		 ...
		 <?php if($restaurants->restaurant_longitude!="" and $restaurants->restaurant_latitude!=""){ ?>
		 var myLatlng = new google.maps.LatLng(<?php echo $restaurants->restaurant_latitude; ?>,<?php echo $restaurants->restaurant_longitude; ?>);
		 <?php }else{ ?>
...
var marker = new google.maps.Marker({
    position: myLatlng,
    title:"<?php echo $restaurants->restaurant_name; ?>",
	 draggable:true,
});
