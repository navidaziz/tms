...
<th><?php echo $this->lang->line('description'); ?></th><th><?php echo $this->lang->line('Action'); ?></th>
                        </tr>
						</thead>
						<tbody>
            ...
            <td>
                <?php echo $system_global_setting->description; ?>
                                ...
                                <a class="llink llink-view" href="<?php echo site_url(ADMIN_DIR."system_global_settings/view_system_global_setting/".$system_global_setting->system_global_setting_id."/".$this->uri->segment(4)); ?>"><i class="fa fa-eye"></i> </a>
                                <a class="llink llink-edit" href="<?php echo site_url(ADMIN_DIR."system_global_settings/edit/".$system_global_setting->system_global_setting_id."/".$this->uri->segment(4)); ?>"><i class="fa fa-pencil-square-o"></i></a>
                                <a class="llink llink-trash" href="<?php echo site_url(ADMIN_DIR."system_global_settings/trash/".$system_global_setting->system_global_setting_id."/".$this->uri->segment(4)); ?>"><i class="fa fa-trash-o"></i></a>
                            </td>
                         </tr>
                      <?php endforeach; ?>
						</tbody>
