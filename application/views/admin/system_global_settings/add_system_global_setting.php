	...
	<div class="box border blue" id="messenger">
        ...
        <div class="box-body">
            ...
            <?php
                ...
                echo form_open_multipart(ADMIN_DIR."system_global_settings/save_data", $add_form_attr);
            ?>
            ...
            <div class="form-group">
                ...
                <?php
                    ...
                    $text = array(
                        ...
                        "value"         =>  set_value("system_sub_title"),
            ...
            <div class="form-group">
                ...
                <?php
                    $label = array(
                        "class" => "col-md-2 control-label",
                        "style" => "",
                    ); echo form_label($this->lang->line('sytem_public_logo'), "sytem_public_logo", $label);      ?>
                ...
                <?php
                    ...
                    $file = array(
                        ...
                        "value"         =>  set_value("sytem_public_logo"),
            ...
            <div class="form-group">
                ...
                <?php
                    $label = array(
                        "class" => "col-md-2 control-label",
                        "style" => "",
                    ); echo form_label($this->lang->line('sytem_admin_logo'), "sytem_admin_logo", $label);      ?>
                ...
                <?php
                    ...
                    $file = array(
                        ...
                        "value"         =>  set_value("sytem_admin_logo"),
