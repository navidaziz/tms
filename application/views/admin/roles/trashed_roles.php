...
foreach($data as $object){
    ...
    $list .= "<td>".status($object->status)."</td>";
    $list .= "<td class='text-center'>
                    <a href='".site_url(ADMIN_DIR."roles/restore_role/".$object->role_id)."' class='ml10' title='Edit Role'><i class='fa fa-undo'></i><a>
                    <a href='".site_url(ADMIN_DIR."roles/delete_role/".$object->role_id)."' class='trash_btn ml10' title='Delete Role'><i class='fa fa-ban'></i><a>
                  </td>";
    $list .= "</tr>";
}
	...
	<div class="col-sm-12">
		<div class="page-header">
			...
			<ul class="breadcrumb">
                ...
                <li>
					<a href="<?php echo site_url(ADMIN_DIR."roles/roles"); ?>">Roles</a>
				</li>
