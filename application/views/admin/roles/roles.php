...
foreach($data as $object){
    ...
    $list .= "<td class='text-center'>
                    <a href='".site_url(ADMIN_DIR."roles/edit_role/".$object->role_id)."' class='ml10' title='Edit Role'><i class='fa fa-edit'></i><a>
                    <a href='".site_url(ADMIN_DIR."roles/trash_role/".$object->role_id)."' class='trash_btn ml10' title='Delete Role'><i class='fa fa-trash-o'></i><a>
                  </td>";
    $list .= "</tr>";
    }
}
