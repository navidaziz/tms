...
<div class="row">
	...
	<div class="box border blue" id="messenger">
		...
		<div class="box-body">
            ...
            <form class="form-horizontal" role="form" method="post" id="role_form" action="<?php echo site_url(ADMIN_DIR."roles/edit_role/".$role->role_id); ?>">
              ...
              <div class="form-group">
				...
				<div class="col-sm-10">
				  <input type="text" class="form-control" id="role_level" name="role_level" placeholder="Role Level" value="<?php echo set_value('role_level', $role->role_level); ?>" />
				</div>
			  </div>
              ...
              <div class="form-group">
				 ...
				 <div class="col-md-10"> 
					<label class="radio"> <input type="radio" class="uniform" name="status" value="1" <?php echo radio_checked($role->status, "1"); ?> /> Active </label> 
					<label class="radio"> <input type="radio" class="uniform" name="status" value="0" <?php echo radio_checked($role->status, "0"); ?> /> Inactive </label> 
					</div>
			  </div>
