...
foreach($actions as $action){
    ...
    $cont_list .= "<td>".status($action->status)."</td>";
    $cont_list .= "<td class='text-center'>
                    <a href='".site_url(ADMIN_DIR."modules/restore_action/".$action->module_id)."/".$controller_id."' title='Restore Controller'><i class='fa fa-undo'></i><a>
                    <a href='".site_url(ADMIN_DIR."modules/delete_action/".$action->module_id)."/".$controller_id."' class='trash_btn ml10' title='Delete Controller'><i class='fa fa-ban'></i><a>
                  </td>";
    $cont_list .= "</tr>";
}
