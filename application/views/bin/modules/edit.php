                ...
                <form class="form-horizontal" method="post" enctype="multipart/form-data" action="<?php echo site_url("modules/edit_controller/" . $controller->module_id); ?>">
                  <div class="box-body">
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-sm-10">
                        <label class="radio"> <input type="radio" class="flat-red" name="status" value="1" <?php echo radio_checked($controller->status, "1"); ?> /> Active </label>
                        <label class="radio"> <input type="radio" class="flat-red" name="status" value="0" <?php echo radio_checked($controller->status, "0"); ?> /> Inactive </label>
                      </div>
                    </div>
