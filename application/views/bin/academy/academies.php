                    ...
                    <?php foreach ($academies as $academy) : ?>
                      <tr>
                        ...
                        <td class="text-center">
                          ...
                          <a style="cursor: pointer;" id="<?php echo $academy->academy_id; ?>" class="user_title_password_details" title="Show user_title & Password"> &nbsp;<i class="fa fa-user"></i></a>
  ...
  <div class="modal fade" id="user_title_password" role="dialog" data-keyboard="false" data-backdrop="static">
    <div class="modal-dialog modal-lg">
      ...
      <div class="modal-content">
        <div class="modal-header" style="background-color: #00a65a;color:#fff;">
          <button type="button" class="close" data-dismiss="modal">&times;</button>
          <h4 class="modal-title" id="user_title_password_modal_one_title">title will be goes dynamically</h4>
        </div>
        <div id="user_title_password_modal_one_content_goes_here">
  ...
  <script type="text/javascript">
    $(".user_title_password_details").on('click', function() {
      var id = $(this).attr('id');
      ...
      $.ajax({
        ...
        success: function(data) {
          ...
          try {
            ...
            $("#user_title_password_modal_one_title").html("School Details");
          } catch (e) {
            location.reload();
          }
