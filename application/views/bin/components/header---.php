          ...
          <ul class="nav navbar-nav">
            ...
            <li class="dropdown user user-menu">
              ...
              <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                ...
                <span class="hidden-xss" style="font-weight: bolder;font-size: 13px;text-transform: uppercase;">
                  <?php echo @ucfirst($this->session->userdata('userTitle')); ?>
              </a>
              <a href="<?php echo base_url('user/logout') ?>" class="btn btn-link" style="display: inline;">Log out</a>
              <ul class="dropdown-menu">
                <!-- User image -->
